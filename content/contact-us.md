...
<div class="prose prose-lg max-w-3xl mx-auto text-gray-700 font-sans">
  ...
  <div class="grid md:grid-cols-2 gap-8 text-center">
    ...
    <div class="bg-brand-gray p-8 rounded-lg shadow-md">
      ...
      <a href="tel:[YOUR_PHONE_NUMBER]" class="text-xl font-semibold text-brand-gold hover:underline">[YOUR_PHONE_NUMBER]</a>
      <p class="mt-4 text-sm text-gray-600">Available from 9 AM to 5 PM [Your Timezone, e.g., EST], Monday - Friday.</p>
    </div>

  </div>

  <div class="mt-16 text-center border-t border-gray-200 pt-10">
      <h2 class="text-3xl font-serif font-semibold text-brand-dark !mb-4">Frequently Asked Questions</h2>
      <p class="mb-6">Many common questions are answered on our <a href="/qa/" class="text-brand-gold hover:underline">Q&A page</a>. We recommend checking there first!</p>
  </div>
